...
module TCAClient
  class SubmissionCompleteWebhookRequest
    ...
    def hash
      [owner, title, status, id, content_type, page_count, word_count, character_count, error_code, created_time, capabilities, metadata].hash
    end
