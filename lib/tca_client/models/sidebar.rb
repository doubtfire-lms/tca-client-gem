...
module TCAClient
  class Sidebar
    ...
    def valid?
      default_mode_validator = EnumAttributeValidator.new('String', ["similarity", "flags", "documentDetails", "sections_exclusion"])
    ...
    def default_mode=(default_mode)
      validator = EnumAttributeValidator.new('String', ["similarity", "flags", "documentDetails", "sections_exclusion"])
