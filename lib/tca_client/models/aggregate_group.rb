...
module TCAClient
  class AggregateGroup
    ...
    attr_accessor :report_generation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TCAClient::AggregateGroup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TCAClient::AggregateGroup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'report_generation')
        self.report_generation = attributes[:'report_generation']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          due_date == o.due_date &&
          report_generation == o.report_generation
    end
    ...
    def hash
      [id, name, type, group_context, due_date, report_generation].hash
    end
