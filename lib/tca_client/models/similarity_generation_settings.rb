...
module TCAClient
  class SimilarityGenerationSettings
    ...
    attr_accessor :auto_exclude_self_matching_scope
    ...
    def self.attribute_map
      {
        ...
        :'auto_exclude_self_matching_scope' => :'auto_exclude_self_matching_scope',
        :'priority' => :'priority'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TCAClient::SimilarityGenerationSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TCAClient::SimilarityGenerationSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'submission_auto_excludes')
        if (value = attributes[:'submission_auto_excludes']).is_a?(Array)
          self.submission_auto_excludes = value
        end
      end

      if attributes.key?(:'auto_exclude_self_matching_scope')
        self.auto_exclude_self_matching_scope = attributes[:'auto_exclude_self_matching_scope']
      end
    ...
    def list_invalid_properties
      ...
      if @search_repositories.nil?
        invalid_properties.push('invalid value for "search_repositories", search_repositories cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          auto_exclude_self_matching_scope == o.auto_exclude_self_matching_scope &&
          priority == o.priority
    end
    ...
    def hash
      [search_repositories, submission_auto_excludes, auto_exclude_self_matching_scope, priority].hash
    end
